...
config_path_for_method() {
  case "$1" in
    markov)
      echo "configs/offline/dtrd_dt/antmaze/umaze_diverse_v2_markov.yaml"
      ;;
    gru)
      echo "configs/offline/dtrd_dt/antmaze/umaze_diverse_v2_gru.yaml"
      ;;
    *)
...
for method in $METHODS; do
  ...
  for seed in $SEEDS; do
    echo "Running ${method} DTRD on antmaze-umaze-diverse-v2 seed=${seed}"
